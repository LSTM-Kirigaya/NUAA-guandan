# Reyn_AI 1.0.0 采用加权思想全新改版
# Author: Ryen Zhang
# University: NUAA

# point-val对应列表
# point_val = [28, 1, 2, 3, 4, 5, 7, 9, 12, 15, 18, 22, 25] # 最开始版本
point_val = [63, 1, 2, 3, 4, 5, 7, 9, 13, 19, 27, 37, 49]   # 目前最强版本
...
# 接敌人牌函数
def get_VAL_OPP(handCards_S, handCards_H, handCards_C, handCards_D, handCards_A, handCards_R, handCards_K, card,
                curRank):
    # 计算出的牌减去的权重
    if card[0] == 'PASS':
        return -99999
...
def check_message(message, pos):
    ...
    if message['greaterPos'] == (pos + 2) % 4:
        ...
        if own_side_action == 'Bomb':
            ...
            if own_side_point == 'T' or own_side_point == 'J' or own_side_point == 'Q' or own_side_point == 'K' or own_side_point == 'A' or own_side_point == 'B' or own_side_point == 'R' or own_side_point == \
                    message['curRank']:
                return 0
            ...
            if own_side_point == '8' or own_side_point == '9' or own_side_point == 'T' or own_side_point == 'J':
                return 0
        ...
        for action_index in range(len(action_List)):
            ...
            if action_List[action_index][0] == own_side_action and action_List[action_index][1] != message['curRank']:
                if point_dic[action_List[action_index][1]] - point_dic[own_side_point] <= 2:
                    return action_index
        else:
            return 0
